...
from common import ORDER_PRODUCTS_SCHEMA, PRODUCTS_SCHEMA, data_dir, get_spark, read_csv, save_csv
...
def main():
    ...
    save_csv(itemsets_pdf, args.output_dir, "fpgrowth_itemsets_spark.csv")
    ...
    save_csv(rules_pdf, args.output_dir, "fpgrowth_rules_spark.csv")
